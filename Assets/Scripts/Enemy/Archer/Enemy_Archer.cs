...
public class Enemy_Archer : Enemy
{
    ...
    public override void AnimationSpecialTrigger()
    {
        ...
        newArrow.GetComponent<Arrow_Controller>().SetupArrow(arrowSpeed * facingDirection, stat);
    }
    ...
    public bool WallBehindCheck() => Physics2D.Raycast(wallCheck.position, Vector2.right * -facingDirection, wallCheckDistance + 2, groundLayer);
